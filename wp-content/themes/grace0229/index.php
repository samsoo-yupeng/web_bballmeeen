...
function jumpNewsList(catId){
	window.location.href = "http://www.bballman.com/?cat=" + catId;
}
</script>
<link rel="stylesheet" href="//cdn.doublemax.net/image/creative/20190613/basketball_list.css">
						...
						query_posts($args);if ( have_posts() ) : ?>
							<div class="ajax-load-box posts-con">
								...
								<?php 
								      $index_ad_i=0; 
						             while ( have_posts() ) : the_post(); 
									include( 'includes/excerpt.php' );
									if($index_ad_i == 0){
								?>
									      <div id="na300250"   class="ajax-load-con content">
												<img id="cf_a"src='%%CF_IMP_URL%%' style='display:none'>
												<a href="%%CF_CLICK_URL%%" target="_blank">
													<div class="cf-content">
														<div class="image"><img src="%%CREATIVE%%"></div>
														<div class="cf-box">
															<span class="cf-icon">廣告</span>
															<a class="cf-title">%%BT_TITLE%%</a>
															<div class="cf-title-text">%%BT_TEXT%%</div>
														</div>
														<div class="cf-info">
															<ul>
																<li class="post-author">
																	<div class="avatar">
																		<img src="https://secure.gravatar.com/avatar/fd2dacfea14e8f9418c79baf6cc00dbe" alt="">
																	</div>
																	<span>%%BT_SPONSOR%%</span><span>贊助</span>
																</li>
															</ul>
														</div>
...
<script src="//cdn.doublemax.net/image/creative/20190613/basketball_list.js"></script>
<?php get_footer(); ?>